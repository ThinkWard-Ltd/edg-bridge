...
const { erc20Mint } = require("../interactions");
...
exports.mintTokens = new commander.Command("mintTokens")
    ...
    .option('--erc20Addr <erc20Addr>')
    .option('--chainId <chainId>')
    .option('--amount <amount>')
    .action(async function(args) {
        const { chainProvider, chainWallet } = getWalletAndProvider(args.rpcUrl, args.privateKey, Number(args.chainId));
        await erc20Mint(Number(args.amount), args.erc20Addr, chainWallet, chainProvider);
    })